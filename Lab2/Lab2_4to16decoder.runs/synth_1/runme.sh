...
HD_PWD='C:/Users/Axelb/Documents/School/WSU Spring 2019/ECE 324/Lab2/Lab2_4to16decoder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fpga_top_Lab2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fpga_top_Lab2.tcl
